...
Instructions:
	...
	-Players may use the left arrow key to turn the board 90 degrees to the left.

	-Players may use the right arrow key to turn the board 90 degrees. Players may not drop a tile and rotate the board on the same turn. 
...
Features:
	...
	Must-have
		...
		- Rotation: Either rotate the board and tiles left or right by 90 degrees (DONE)
		...
		- GUI: Start Screen and end screen with instructions, start, and menu buttons. (DONE)
	...
	Want-to-have
		...
		- Settings Menu: select which Special features you want to enable or disable (DONE)
	...
	Stretch
		...
		- Different Rotations: Allowing the player to rotated by different angles, such as 45 degrees, 180 degrees, etc. (NOT DONE)
...
Class list:
	...
	-Game: The game of connect four with special features
	...
	-FileIO: Class that handles reading and writing to save files.
